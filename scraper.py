...
url="http://www.ppaghana.org/contractresults.asp?Ministry=%25&Agency=%25&ppb_date=10000&Submit=Search&offset=%d"
...
contract_urls=set(reduce(lambda x,y: x+y,[get_contract_urls(url%p) for p in range(1,10)]))
